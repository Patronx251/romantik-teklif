...
document.addEventListener("click", (e) => {
    ...
    if (e.target.matches("#hayir-btn") || e.target.closest("#hayir-btn")) {
        return;
    }
    // "Evet" linkine tıklanırsa diğer işlemleri yapma, sayfanın yönlenmesine izin ver
    if (e.target.matches(".evet-buton") || e.target.closest(".evet-buton")) {
        return;
    }
